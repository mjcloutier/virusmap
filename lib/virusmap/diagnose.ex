defmodule Virusmap.Diagnose do
  @moduledoc """
  The Diagnose context.
  """

  import Ecto.Query, warn: false

  alias Virusmap.{Diagnose.Diagnosis, Repo}
  ...
  ## Examples
      ...
      %Ecto.Changeset{source: %Diagnosis{}}

  """
  def change_diagnosis(%Diagnosis{} = diagnosis) do
